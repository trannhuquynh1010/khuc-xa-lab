    ...
    <div className="ray-guide">
      ...
      <div className="ray-guide-layout">
        <svg className="ray-diagram" viewBox="0 0 720 380" role="img" aria-labelledby="ray-diagram-title ray-diagram-description">
          ...
          <defs>
            <marker id="ray-arrow" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto" markerUnits="strokeWidth"><path d="M0 0 L8 4 L0 8 Z" /></marker>
          </defs>
          ...
          <text className="object-label" x="280" y={below ? 354 : 112}>{scenario.objectLabel} thật</text>
          ...
          {step >= 1 && <g className="incident-rays">
            ...
            <text x="344" y={below ? 244 : 128}>Tia tới</text>
          </g>}
          {step >= 2 && <g className="normal-line">
            <line x1="420" y1="104" x2="420" y2="276" />
            <text x="430" y="118">Pháp tuyến</text>
          ...
          {step >= 3 && <g className="refracted-rays">
            ...
            <text x={below ? 520 : 470} y={below ? 105 : 285}>Tia khúc xạ</text>
          </g>}
          {step >= 4 && <g className="virtual-construction">
            ...
            <text x="295" y={below ? imageY - 8 : imageY + 3}>Ảnh ảo</text>
          </g>}
        </svg>
