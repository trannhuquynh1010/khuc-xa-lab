...
const stations: OpticsQuestQuestion[][] = [
  ...
  [
    ...
    { id: "a-fish-ray-turn", station: 2, stationLabel: "Mắt nhìn dưới nước", title: "Tia sáng từ con cá", prompt: "Tia sáng từ con cá truyền từ nước ra không khí có góc tới i = 30° và góc khúc xạ r = 45°. Tia đổi hướng một góc |r − i| bằng bao nhiêu?", kind: "number", answer: "15", unit: "°", tolerance: 0.01, explanation: "Độ đổi hướng là |45° − 30°| = 15°; tia khúc xạ lệch xa pháp tuyến.", visual: "apparent" },
    { id: "a-diver-ray-turn", station: 2, stationLabel: "Mắt nhìn dưới nước", title: "Ánh đèn đến thợ lặn", prompt: "Tia sáng từ đèn trên bờ truyền từ không khí vào nước có i = 40° và r = 28°. Tia đổi hướng một góc |i − r| bằng bao nhiêu?", kind: "number", answer: "12", unit: "°", tolerance: 0.01, explanation: "Độ đổi hướng là |40° − 28°| = 12°; tia khúc xạ lệch gần pháp tuyến.", visual: "apparent" },
  ],
  [
